...
CREATE USER SPRING_LSM IDENTIFIED BY SPRING1234;

GRANT CONNECT, RESOURCE TO SPRING_LSM;

ALTER USER SPRING_LSM DEFAULT TABLESPACE USERS QUOTA 20M ON USERS;
...
-- CHAR(10) : 고정길이 문자열 10byte (최대 2000byte)
-- VARCHAR2(10) : 가변 길이 문자열 10byte (최대 4000byte)
...
-- 샘플 회원 데이터 삽입
INSERT INTO "MEMBER" VALUES(SEQ_MEMBER_NO.NEXTVAL, 'member01@kh.or.kr', '$2a$10$S8Y7ilUrt0/OLqqdpyWWUuXFkcVtOwPlDQeimHxQfEFEmouVCc/Ia',
	'샘플1', '01012341234', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);




-- 로그인  < - BCrypt 암호화 사용중 DB에서 비밀번호 비교 불가능! 그래서 비밀번호를 조회 => 이메일이 일치하는 회원+ 탈퇴 안한 회원 조건만 추가
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME, MEMBER_PW, MEMBER_TEL, MEMBER_ADDRESS, PROFILE_IMG, AUTHORITY,
	TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') ENROLL_DATE 
FROM "MEMBER"
WHERE MEMBER_EMAIL = ? AND MEMBER_DEL_FL = 'N' ;
...
SELECT COUNT(*)
FROM "MEMBER"
WHERE MEMBER_DEL_FL = 'N' AND MEMBER_NICKNAME = '샘플1';
...
WHERE EMAIL = 'h8245782457@gmail.com'
AND AUTH_KEY = '26UGOJ';

-- 회원 정보 수정
UPDATE "MEMBER"
SET MEMBER_NICKNAME = '수정',
	MEMBER_TEL = '01011111111',
	MEMBER_ADDRESS = '04540^^^서울시 중구 남대문로 120^^^수정'
WHERE MEMBER_NO = '2';

-- 암호화된 비밀번호 조회
SELECT MEMBER_PW FROM MEMBER WHERE MEMBER_NO = '2';


UPDATE "MEMBER"
SET MEMBER_PW = '$2a$10$MQbXi2Brz3FXqHy0cIR4..eBelXR3ZNZnJUIHnMFCNhZXAkgAep.u'
WHERE 	MEMBER_NO = '2';
...
CREATE TABLE "BOARD" (
	...
	"BOARD_WIRTE_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
...
COMMENT ON COLUMN "BOARD"."BOARD_WIRTE_DATE" IS '게시글 작성일';
...
-- 댓글 삭제 여부 (COMMENT는 꼭 ""와 같이 사용! <- 예약어로 인식)
...
/* 댓글 ("COMMENT") 테이블 샘플 데이터 삽입 */ 
BEGIN
	FOR I IN 1..2000 LOOP
		INSERT INTO "COMMENT"
		VALUES(SEQ_COMMENT_NO.NEXTVAL, SEQ_COMMENT_NO.CURRVAL || '번쨰 댓글 입니다.',
			DEFAULT, DEFAULT, CEIL( DBMS_RANDOM.VALUE(0, 2000) ), 2, NULL
			);
...
/* 특정 게시판 (BOARD_CODE) 에 삭제되니 않은 게시글 목록 조회 */
-- 	단, 최신글이 가장 위에 존재, 몇 초/분/시간 전 또는 YYYY-MM-DD 형식으로 작성일 조회 + 댓글 개수, 좋아요 개수
-- 		ㄴ 번호 / 제목[댓글개수] / 작성자닉네임 / 조회수 / 좋아요개수 / 작성일

																	-- 상관 서브 쿼리
																	-- 1) 메인 쿼리 1행 조회
																	-- 2) 1행 조회 결과를 이용, 서브쿼리 수행 ( 1~2를 메인쿼리 모두 조회할떄까지 반복)
...
FROM "BOARD" B
JOIN MEMBER USING (MEMBER_NO)
WHERE BOARD_DEL_FL = 'N' AND BOARD_CODE = '1'
ORDER BY BOARD_NO DESC;

-- 상관쿼리 따로 --
-- 특정 게시글의 댓글 개수 조회
SELECT COUNT(*) FROM "COMMENT" WHERE BOARD_NO = 2000;
...
-- "BOARD" 테이블 BOARD_WIRTE_DATE 컬럼명 수정
ALTER TABLE "BOARD" RENAME COLUMN BOARD_WIRTE_DATE TO BOARD_WRITE_DATE;
...
INSERT INTO "BOARD_IMG" VALUES(SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본1.jpg', 'test1.jpg', 0, 1999);
INSERT INTO "BOARD_IMG" VALUES(SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본2.jpg', 'test2.jpg', 1, 1999);
INSERT INTO "BOARD_IMG" VALUES(SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본3.jpg', 'test3.jpg', 2, 1999);
INSERT INTO "BOARD_IMG" VALUES(SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본4.jpg', 'test4.jpg', 3, 1999);
INSERT INTO "BOARD_IMG" VALUES(SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본5.jpg', 'test5.jpg', 4, 1999);
...
INSERT INTO "COMMENT"	VALUES(SEQ_COMMENT_NO.NEXTVAL,'부모 댓글1',DEFAULT, DEFAULT, 2000,2,NULL);
INSERT INTO "COMMENT"	VALUES(SEQ_COMMENT_NO.NEXTVAL,'부모 댓글2',DEFAULT, DEFAULT, 2000,2,NULL);
INSERT INTO "COMMENT"	VALUES(SEQ_COMMENT_NO.NEXTVAL,'부모 댓글3',DEFAULT, DEFAULT, 2000,2,NULL);
...
-- 부모 댓글1의 자식 댓글1,2
INSERT INTO "COMMENT"	VALUES(SEQ_COMMENT_NO.NEXTVAL,'부모 댓글 1의 자식 댓글1',DEFAULT, DEFAULT, 2000,2,6003);
INSERT INTO "COMMENT"	VALUES(SEQ_COMMENT_NO.NEXTVAL,'부모 댓글 1의 자식 댓글2',DEFAULT, DEFAULT, 2000,2,6003);

-- 부모 댓글2의 자식 댓글1,2
INSERT INTO "COMMENT"	VALUES(SEQ_COMMENT_NO.NEXTVAL,'부모 댓글 1의 자식 댓글1',DEFAULT, DEFAULT, 2000,2,6004);
INSERT INTO "COMMENT"	VALUES(SEQ_COMMENT_NO.NEXTVAL,'부모 댓글 1의 자식 댓글2',DEFAULT, DEFAULT, 2000,2,6004);
