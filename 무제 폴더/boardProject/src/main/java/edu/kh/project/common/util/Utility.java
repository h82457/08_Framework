...
public class Utility {
	 ...
	 * @return
	 */
	public static String fileRename(String originalFileName) { // static 사용, Utility.fileRename() 으로 간단하게 호출 가능
		...
		// "문자열".lastIndexOf(".")
		// - 문자열에서 마지막 "."의 인덱스 반환
		String ext = originalFileName.substring(originalFileName.lastIndexOf("."));// ->.jpg 반환
