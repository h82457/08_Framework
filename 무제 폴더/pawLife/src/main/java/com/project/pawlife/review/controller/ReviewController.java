...
//    public void smarteditorImageUpload(MultipartFile file,HttpServletRequest req, HttpServletResponse resp) throws IOException {
//        try{
//            if(file.isEmpty()) {
...
//                
//                String rename = file.getOriginalFilename().split("\\.")[0] + UUID.randomUUID() + "-" + today + "."+ fileExt;
//              
//                File saveFile = new File(saveDir, rename);
//                try {
...
//                sFileInfo += "&sFileName="+originalName; // originalName
//                sFileInfo += "&sFileURL="+webPath+rename; // rename
...
//	 
//	@ResponseBody
//	@PostMapping(value="imageUpload1")
